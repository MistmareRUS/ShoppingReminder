...
namespace ShoppingReminder
{
    public partial class MainPage : Shell
    {
        ...
        public MainPage()
        {
            ...
            NameLabel.FontFamily = Device.RuntimePlatform == Device.Android ? "jakobextractt.ttf#JacobExtraCTT" : "Assets/jakobextractt.ttf#JacobExtraCTT";//TODO: позже перенести в XAML
        ...
        public void GetPhotos(string source, StackLayout layout, ICommand back, ICommand deletePhoto, ICommand deletePhotos)
        {
            ...
            layout.Children.Add(new StackLayout {
                Children = { countLbl, listBtnStack },
                Orientation=StackOrientation.Horizontal,
                HorizontalOptions=LayoutOptions.FillAndExpand,
